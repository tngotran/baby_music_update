	 ...
	 $(document).ready(function(){
		 ...
		 $('#kara').click(function(){     // Chỗ on là bạn thay cái id mà bạn đặt cho button
	 	 ...
	 	 $('#turnOffCom').click(function(){     // Chỗ off là bạn thay cái id mà bạn đặt cho button
	   		console.log("call php shutdown");
			var a = new XMLHttpRequest();
		 	a.open("GET", "light.php", true);   // thay cái tatden.php thành file thực thi của bạn
		        a.onreadystatechange=function(){
			    if(a.readyState==4){
				     if(a.status == 200){
		 ...
		 $('#rain').click(function(){     // Chỗ off là bạn thay cái id mà bạn đặt cho button
	   		
			console.log("rain clicked")
			var a = new XMLHttpRequest();
		 	a.open("GET", "music.php?q="+"rain",true);   // thay cái tatden.php thành file thực thi của bạn
		        a.onreadystatechange=function(){
			    if(a.readyState==4){
				     if(a.status == 200){
				     }
...
<!--   <button type="button" id="pl1">play List1</button><br>
  ...
  <!-- <button type="button" id="musicOn">Music On</button><br> -->
	...
	<button style="height:300px;width:500px;color:green;font-size:40px" type="button" id="musicOff">Music Off</button>
<!--	<button type="button" id="next" onclick="nextSong()">Next Song</button><br> -->

	<br><br>Classical Music:
	<button class="button1" type="button" id="mozart">Mozart</button>
	<button class="button2" type="button" id="rain">Rain</button>
	<button class="button1" type="button" id="yiruma">Yiruma</button>
	<button class="button2" type="button" id="beethoven">Beethoven</button>

	<br><br>Morning Songs:
	<button class="button2" type="button" id="wakeup">Bird</button>
	<button class = "button1" type="button" id="sleep">Sleep1</button> 
	<button class = "button2" type="button" id="bath">Sleep2</button>

	<br><br> Volume Control:
	<button class="button3" type="button" id="vlUp">Volume UP   /\</button> 
	<button class="button3" type="button" id="vlDown">DOWN \/</button>
	<button class="button3" type="button" id="vlMute">Mute X</button>
	<br><br>
